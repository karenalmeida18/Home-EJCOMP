                    ...
                    <div className='membroCompleto'>
                        <div className='modalMembro'>
                            ...
                            <div className='fotoMembroEdit'>
                                {this.state.avatar2 ?
                                    <img alt='fotomembro' className='imageMembro' src={this.state.changeSrc ? this.state.src : baseURL + '/members/' + this.state.avatar2.filename} ></img>
                                    : <p>Sem foto</p>}
                            </div>
                    ...
                    {members.length > 0 ?
                        members.map(member => (
                            <div key={member._id} className='cardMembros' onClick={() => this.showMembro(member)}>
                                ...
                                {member.avatar !== null ?
                                    < img alt='fotoMembro' className='imageMembro' src={baseURL + '/members/' + member.avatar.filename} />
                                    : <p>Membro sem foto</p>
                                }
                            </div>
